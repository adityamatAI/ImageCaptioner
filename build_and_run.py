# build_and_run.py (Fully Corrected Version)
...
# --- Corrected Imports ---
# Import model layers directly from Keras
from keras.applications.vgg16 import VGG16, preprocess_input
from keras.models import Model
from keras.layers import Input, Dense, LSTM, Embedding, Dropout, add
from keras.utils import to_categorical, plot_model

# Import preprocessing tools from their specific, stable locations
from keras.preprocessing.image import load_img, img_to_array
from keras.preprocessing.sequence import pad_sequences
from tensorflow.keras.preprocessing.text import Tokenizer # Using tensorflow.keras for this one is more stable for linters
...
def extract_features(directory):
    # Using pooling='avg' creates a feature vector of size 512
...
# --- 4. Tokenize Text and Create Data Generator ---
...
def data_generator(captions, features, tokenizer, max_length, vocab_size, batch_size=32):
    ...
    while True:
        ...
        for i in range(0, len(image_ids), batch_size):
            ...
            # FIX 3: Yield a tuple of tuples, not a tuple containing a list
            yield ((np.array(X1), np.array(X2)), np.array(y))

# --- 5. Define the Model Architecture ---
def define_model(vocab_size, max_length):
    # FIX 2: The input shape for features is 512, not 4096
...
# FIX 1 & 2: Use tf.data.Dataset and provide the correct output signature
output_signature = (
    (tf.TensorSpec(shape=(None, 512), dtype=tf.float32),  # Shape is 512
...
# --- 7. Generate Captions for an Example Image ---
